        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenHienThi = table.Column<string>(maxLength: 200, nullable: true),
                    NgaySinh = table.Column<DateTime>(type: "date", nullable: true),
                    GioiTinh = table.Column<bool>(nullable: true),
                    MaTinh = table.Column<int>(nullable: true),
                    MaHuyen = table.Column<int>(nullable: true),
                    MaXa = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "Tinhs",
                        principalColumn: "MaTinh",
                        onDelete: ReferentialAction.NoAction); // Sử dụng NoAction
                    table.ForeignKey(
